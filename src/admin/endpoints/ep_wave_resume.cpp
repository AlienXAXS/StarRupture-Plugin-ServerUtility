...
static const char* WaveResume_SEH()
{
	__try
	{
		...
		ws->ResumeCurrentWave();
		return R"({"ok":true})";
	}
	__except (EXCEPTION_EXECUTE_HANDLER)
	{
		return R"({"ok":false,"error":"exception resuming wave"})";
	}
}
#endif

namespace Ep_WaveResume
{
